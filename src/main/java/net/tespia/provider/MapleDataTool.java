...
import net.tespia.provider.WzXML.MapleDataType;
...
public class MapleDataTool {
  ...
  public static int getInt(MapleData data) {
    if (data.getType() == MapleDataType.STRING) {
      return Integer.parseInt((String) data.getData());
    }
  ...
  public static boolean getBoolean(String path, MapleData data) {
    MapleData e = data.getChildByPath(path);
    if (e.getData() == null || MapleDataTool.getInt(path, data) == 0) {
      return false;
    }
    return true;
  }
